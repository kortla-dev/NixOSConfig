...
let
  ...
  rawFmt = ''
    $username$hostname $directory$git_branch$git_state$git_status$cmd_duration$fill$zig$c$lua$rust$cpp$php$nix_shell
...
#
#   rawFmt = ''
#     $username$hostname $directory$git_branch$git_state$git_status$cmd_duration$fill$zig$c$lua$rust$cpp$java$php$nix_shell
#     $line_break$character
#   '';
#
